    ...
    >
      <View style={styles.header}>
        ...
        <Text style={[styles.subtitle, { color: theme.colors.textSecondary }]}>
          Start splitting expenses the beautiful way.
        </Text>
      </View>
      ...
      >
        {loading ? (
          ...
          <Text style={[styles.submitBtnText, { color: theme.slate[950] }]}>Create Account</Text>
        )}
      </Pressable>

      <View style={styles.footer}>
        <Text style={{ color: theme.colors.textSecondary }}>Already have an account? </Text>
        <Link href="/(auth)/login" style={[styles.footerLink, { color: theme.mint[400] }]}>
          Sign in
        </Link>
      </View>
    </KeyboardAvoidingView>
